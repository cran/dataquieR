...
This is a brief example report using `dataquieR`'s functions. Also, all figure outputs
are displayed as icons only to avoid big files on CRAN. For a longer and
...
```{r message=FALSE, echo=TRUE, warning=FALSE, results = 'hide', fig.keep = 'all', fig.align="center", fig.height = 5, fig.width = 7}
